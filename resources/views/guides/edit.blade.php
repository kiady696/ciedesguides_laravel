...
@section('guides.content')
        ...
        <div class="card">
            <div class="card-header d-flex flex-row align-items-center justify-content-between">
                <ol class="breadcrumb m-0 p-0">
                    ...
                    <li class="breadcrumb-item">@lang('Edit Guide') #{{$guide->id}}</li>
                </ol>
            </div>
            <div class="card-body">
                <form action="{{ route('guides.update', compact('guide')) }}" method="POST" class="m-0 p-0">
                    @method('PUT')
                    @csrf
                    <div class="card-body">
                        <div class="mb-3">
        <label for="code_Guides" class="form-label">Code Guides:</label>
        <input type="number" name="code_Guides" id="code_Guides" class="form-control" value="{{@old('code_Guides', $guide->code_Guides)}}" required/>
    ...
    <div class="mb-3">
        ...
        <textarea name="nom_Guides" id="nom_Guides" class="form-control" >{{@old('nom_Guides', $guide->nom_Guides)}}</textarea>
    ...
    <div class="mb-3">
        ...
        <textarea name="prenom_Guides" id="prenom_Guides" class="form-control" >{{@old('prenom_Guides', $guide->prenom_Guides)}}</textarea>
    ...
    <div class="mb-3">
        ...
        <textarea name="email_Guides" id="email_Guides" class="form-control" >{{@old('email_Guides', $guide->email_Guides)}}</textarea>
    ...
    <div class="mb-3">
        ...
        <textarea name="motdepasse_Guides" id="motdepasse_Guides" class="form-control" >{{@old('motdepasse_Guides', $guide->motdepasse_Guides)}}</textarea>
		...
		@endif
                    ...
                    <div class="card-footer">
                        <div class="d-flex flex-row align-items-center justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">@lang('Update Guide')</button>
                        </div>
                    </div>
                </form>
            </div>
