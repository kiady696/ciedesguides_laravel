...
@section('abris.content')
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('vallees.abris.store', compact('vallee')) }}" method="POST" class="m-0 p-0">
                    <div class="card-body">
                        @csrf
                        <div class="mb-3">
		...
		@endif
                    ...
                    <div class="card-footer">
                        <div class="d-flex flex-row align-items-center justify-content-between">
                            <a href="{{ route('vallees.abris.index', compact('vallee')) }}" class="btn btn-light">@lang('Cancel')</a>
