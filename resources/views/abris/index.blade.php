    ...
    <div class="container">
        <div class="card">
            <div class="card-header d-flex flex-column flex-md-row align-items-md-center justify-content-between">
                ...
                <form action="{{ route('abris.index', []) }}" method="GET" class="m-0 p-0">
    ...
    @foreach($abris as $abri)
        <tr>
            ...
            <td data-label="Actions:" class="text-nowrap">
                                   <a href="{{route('abris.show', compact('abri'))}}" type="button" class="btn btn-primary btn-sm me-1">@lang('Show')</a>
<div class="btn-group btn-group-sm">
    <button type="button" class="btn btn-light dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa fa-cog"></i></button>
    <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="{{route('abris.edit', compact('abri'))}}">@lang('Edit')</a></li>
        <li>
            <form action="{{route('abris.destroy', compact('abri'))}}" method="POST" style="display: inline;" class="m-0 p-0">
                @csrf
                @method('DELETE')
    ...
    @endforeach
            ...
            <div class="text-center my-2">
                <a href="{{ route('abris.create', []) }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('Create new Abri')</a>
            </div>
        </div>
    </div>
@endsection
